<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-200 shadow-sm dark:border-gray-700">
    <!-- Primary Navigation Menu -->
    <div class="max-w-9xl mx-auto">
        <div class="flex justify-between h-16 mx-5 md:mx-10">
            <div class="flex items-center">
                ...
                <div class="shrink-0 flex items-center gap-3">
                    ...
                    <h1 class="sm:hidden flex font-extrabold text-gray-700 dark:text-white text-2xl uppercase">
                        Good
                        Go<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="6"
                            stroke="currentColor" class="text-blue-500 w-7">
                ...
                <!-- Navigation Links -->
                <div
                    class="hidden no-scrollbar space-x-8 sm:-my-px sm:ms-5 sm:flex font-bold uppercase whitespace-nowrap overflow-auto">
                ...
                <x-contents.admin>
                    <div class="hidden sm:flex sm:items-center whitespace-nowrap">
                        <x-navs.dropdown align="right" width="48">
                            <x-slot name="trigger">
                                <button
                                    class="inline-flex items-center px-3 py-2 border border-transparent text-base leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none">
                                    <img class="w-8 h-8 rounded-full" src="{{ asset('images/gg-ph-logo.png') }}"
                                        alt="user photo">
                                </button>
                            </x-slot>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @foreach ($electionTypes as $type)
                <x-navs.responsive-nav-link :href="route('candidates.index', $type)" :active="Str::contains(request()->url(), $type)">
                    {{ Str::ucfirst($type) }} Candidates
                </x-navs.responsive-nav-link>
            @endforeach
        </div>
