<section id="team">
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center mt-5">
        ...
        <div class="grid gap-8 lg:gap-16 grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            @foreach ([
                ['name' => 'Bonnie Green', 'role' => 'CEO/Co-founder', 'image' => 'https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/bonnie-green.png'],
                ['name' => 'Helene Engels', 'role' => 'CTO/Co-founder', 'image' => 'https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/helene-engels.png'],
                ['name' => 'Jese Leos', 'role' => 'SEO & Marketing', 'image' => 'https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/jese-leos.png'],
                ['name' => 'Joseph Mcfall', 'role' => 'Sales', 'image' => 'https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/joseph-mcfall.png']
            ] as $member)
            <article class="text-center text-gray-500 dark:text-gray-400">
                <header>
                    <img class="mx-auto mb-4 w-28 h-28 md:w-36 md:h-36 rounded-full" src="{{ $member['image'] }}" alt="{{ $member['name'] }} Avatar">
                    <h3 class="mb-1 text-lg md:text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                            <a href="#">{{ $member['name'] }}</a>
                    </h3>
                    <p class="text-sm md:text-base">{{ $member['role'] }}</p>
                </header>
                <nav>
                    <ul class="flex justify-center mt-2 space-x-2 md:mt-4 md:space-x-4">
                        <li>
