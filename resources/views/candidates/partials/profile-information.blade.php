<section>
    <div class="flex md:flex-col w-full font-light text-gray-500 sm:text-lg dark:text-gray-400 space-y-5">

      <div class="w-full bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
        <div class="flex flex-col items-center p-7">
            <img class="w-40 h-auto mb-3 rounded-full shadow-lg" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/bonnie-green.png" alt="Bonnie image"/>
            <h5 class="mb-1 text-lg font-medium text-gray-900 dark:text-white capitalize">{{ Str::lower($candidate->can_firstname . " " . $candidate->can_middlename[0] . ". ". $candidate->can_lastname) }}</h5>
      ...
      <div class="w-full bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
        <ul class="flex flex-col items-center justify-center p-4 space-y space-y-4 text-sm font-medium text-gray-500 dark:text-gray-400 md:me-4 mb-4 md:mb-0 w-full">
          ...
          <li class="w-full">
              <a href="#plans" class="inline-flex items-center px-4 py-3 rounded-lg hover:text-gray-900 bg-gray-50 hover:bg-gray-100 w-full dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white">
