<div class="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 p-5 rounded-md">
    ...
    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Please fill in the candidate's relevant professional and
        political experiences.</p>

    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
        <section class="col-span-2">
            <x-forms.input-label value="Position Held" />
            <x-forms.text-input color="gray" label="Position Held" name="position" id="position" type="text"
                placeholder="e.g. Mayor, Senator, Barangay Captain" />
            <x-forms.input-error :messages="$errors->get('position')" class="mt-2" />
        </section>

        <section class="col-span-2">
            <x-forms.input-label value="Organization / Government Unit" />
            <x-forms.text-input color="gray" label="Organization" name="organization" id="organization" type="text"
                placeholder="e.g. Quezon City LGU" />
