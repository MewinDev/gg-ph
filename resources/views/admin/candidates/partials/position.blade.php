            ...
            @foreach ($positions as $position)
                <div class="flex items-center">
                    ...
                    <label for="{{ $position->id }}"
                        class="group inline-flex items-center justify-between w-full py-2 px-4 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked:text-blue-500 peer-checked:border-blue-600 dark:peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                        <div class="w-full text-sm font-semibold capitalize">{{ $position->pos_name }}</div>
                        <svg class="group-hover:text-blue-500 dark:group-hover:text-blue-500 w-5 h-5 ms-3 rtl:rotate-180"
